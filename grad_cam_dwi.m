...
save_avw(gradcamMap,'savedwi_cam.nii.gz','f',[2 2 2]);
system('/usr/local/fsl/bin/fslcpgeom /usr/local/fsl/data/standard/MNI152_T1_2mm_brain.nii.gz savedwi_cam.nii.gz');